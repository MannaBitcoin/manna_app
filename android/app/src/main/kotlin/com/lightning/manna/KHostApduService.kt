...
//    private val NDEF_ID = byteArrayOf(0xE1.toByte(), 0x04.toByte())
    ...
    private var NDEF_URI = NdefMessage(NdefRecord.createTextRecord("en", "Manna"))
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        if (intent?.hasExtra("ndefURI")!!) {
            NDEF_URI =
                NdefMessage(NdefRecord.createUri(intent.getStringExtra("ndefURI")!!))
        ...
        Log.i(tag, "onStartCommand() | $NDEF_URI")
...
//    }
//
//    private fun createURIRecord(text: String, id: ByteArray): NdefRecord {
//        val textBytes: ByteArray
//        try {
//            textBytes = text.toByteArray(charset("UTF-8"))
//        } catch (e: UnsupportedEncodingException) {
...
//
//        recordPayload[0] = 0x00
//        System.arraycopy(textBytes, 0, recordPayload, 1, textBytes.size)
//
