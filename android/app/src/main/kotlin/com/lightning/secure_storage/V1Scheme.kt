...
class V1Scheme(
    ...
    private fun timeOutCipher(block: () -> Unit) {
    ...
    /** This method returns secretKey handle, the key bytes are never exposed to app process */
    ...
    override fun initEncryptCipher(alias: String): Cipher {
        ...
        try {
            timeOutCipher { cipher.init(Cipher.ENCRYPT_MODE, key) }
    ...
    override fun generateKey(
        ...
        Aes256GcmKeyGenerator.generateKey(
            alias,
