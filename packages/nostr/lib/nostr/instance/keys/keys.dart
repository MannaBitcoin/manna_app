...
class NostrKeys {
  ...
  String sign({
    ...
    final hexEncodedMessage = Nostr.instance.services.utils.hexEncodeString(message);
  ...
  bool verify({
    ...
    final hexEncodedMessage = Nostr.instance.services.utils.hexEncodeString(message);
    final isVerified = NostrKeyPairs.verify(publicKey, hexEncodedMessage, signature);
