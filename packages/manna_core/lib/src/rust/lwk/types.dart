...
// These function are ignored because they are on traits that is not defined in current crate (put an empty `#[frb]` on it to unignore): `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `eq`, `eq`, `eq`, `eq`, `eq`, `eq`, `eq`, `eq`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `from`, `from`, `from`, `from`, `from`
...
class Address {
  ...
  static Future<Address> addressFromScript({
    ...
    String? blindingKey,
  }) => MannaCore.instance.api.crateLwkTypesAddressAddressFromScript(
    network: network,
    script: script,
  ...
  static Future<Network> validate({required String addressString}) => MannaCore
      .instance
      .api
      .crateLwkTypesAddressValidate(addressString: addressString);
...
class DecodedPset {
  ...
  final List<String> inputAddressDerivations;
  ...
  const DecodedPset({
    ...
    required this.inputAddressDerivations,
  });
  ...
  int get hashCode =>
      ...
      fees.hashCode ^
      balances.hashCode ^
      inputAddressDerivations.hashCode;
  ...
  bool operator ==(Object other) =>
      ...
      other is DecodedPset &&
          ...
          inputAddressDerivations == other.inputAddressDerivations;
}
...
class Fee {
  ...
  const Fee({required this.assetId, required this.value});
...
class Tx {
  ...
  static Tx fromJsonString({required String jsonStr}) =>
      MannaCore.instance.api.crateLwkTypesTxFromJsonString(jsonStr: jsonStr);

  String toJsonString() =>
      MannaCore.instance.api.crateLwkTypesTxToJsonString(that: this);
