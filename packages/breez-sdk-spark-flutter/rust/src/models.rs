...
#[frb(sync)]
pub fn serialize_payment_to_json(payment: Payment) -> Result<String, String> {
    serde_json::to_string(&payment).map_err(|e| e.to_string())
}

#[frb(sync)]
pub fn deserialize_payment_from_json(json_str: String) -> Result<Payment, String> {
