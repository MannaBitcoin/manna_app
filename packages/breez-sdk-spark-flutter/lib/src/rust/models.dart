...
String serializePaymentToJson({required Payment payment}) =>
    BreezSdkSparkLib.instance.api.crateModelsSerializePaymentToJson(payment: payment);

Payment deserializePaymentFromJson({required String jsonStr}) =>
    BreezSdkSparkLib.instance.api.crateModelsDeserializePaymentFromJson(jsonStr: jsonStr);
