...
class BreezSdkSparkLib
  ...
  @override
  int get rustContentHash => 1903884504;
...
abstract class BreezSdkSparkLibApi extends BaseApi {
  ...
  Payment crateModelsDeserializePaymentFromJson({required String jsonStr});
  ...
  String crateModelsSerializePaymentToJson({required Payment payment});
...
class BreezSdkSparkLibApiImpl extends BreezSdkSparkLibApiImplPlatform implements BreezSdkSparkLibApi {
  ...
  Payment crateModelsDeserializePaymentFromJson({required String jsonStr}) {
    return handler.executeSync(
      SyncTask(
        ...
        codec: SseCodec(decodeSuccessData: sse_decode_payment, decodeErrorData: sse_decode_String),
        constMeta: kCrateModelsDeserializePaymentFromJsonConstMeta,
        argValues: [jsonStr],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateModelsDeserializePaymentFromJsonConstMeta =>
      const TaskConstMeta(debugName: "deserialize_payment_from_json", argNames: ["jsonStr"]);
  ...
  String crateModelsSerializePaymentToJson({required Payment payment}) {
    return handler.executeSync(
      SyncTask(
        ...
        constMeta: kCrateModelsSerializePaymentToJsonConstMeta,
        argValues: [payment],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateModelsSerializePaymentToJsonConstMeta =>
      const TaskConstMeta(debugName: "serialize_payment_to_json", argNames: ["payment"]);
