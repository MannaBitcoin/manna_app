      ...
      final tGet = """
        T _get<T>(
          ...
          T parseValue(String strValue) {
            bool equalsType<Y>() => T == Y;
          
            if (equalsType<String>() || equalsType<String?>()) {
              return strValue as T;
            } else if (equalsType<int>()) {
              return int.parse(strValue) as T;
            } else if (equalsType<int?>()) {
              return int.tryParse(strValue) as T;
            } else if (equalsType<double>()) {
              return double.parse(strValue) as T;
            } else if (equalsType<double?>()) {
              return double.tryParse(strValue) as T;
            } else if (equalsType<bool>()) {
              return bool.parse(strValue, caseSensitive: false) as T;
            } else if (equalsType<bool?>()) {
              return bool.tryParse(strValue, caseSensitive: false) as T;
          ...
          if (!jsonMap.containsKey(key) || jsonMap[key] == null) {
            if (isNullable<T>()) {
              ...
              throw Exception('Key \$key not found or has a null value');
            }
          }
